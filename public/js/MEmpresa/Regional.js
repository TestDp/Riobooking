...
function ajaxRenderSectionCrearRegional() {
    PopupPosition();
    $.ajax({
        type: 'GET',
        url: urlBase +'crearRegional',
        dataType: 'json',
...
function GuardarRegional() {
    PopupPosition();
    var form = $("#formRegional");
    var token = $("#_token").val()
    $.ajax({
        type: 'POST',
        url: urlBase +'guardarRegional',
        dataType: 'json',
...
function ajaxRenderSectionListaRegionales() {
    PopupPosition();
    $.ajax({
        type: 'GET',
        url: urlBase +'regionales',
        dataType: 'json',
        success: function (data) {
            OcultarPopupposition();
            $('#principalPanel').empty().append($(data));
