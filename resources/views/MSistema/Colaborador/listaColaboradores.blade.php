    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="panel panel-success">
                <div class="panel-heading"><h3>Profesionales</h3></div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <button onclick="ajaxRenderSectionCrearColaborador()" type="button" class="btn btn-success">Nuevo Profesional</button>
                        </div>
