...
class CitasRepositorio implements ICitasRepositorio
{
    ...
    public function CruceCitas($idUsuario,$informacionCitaReservada, $InicioAReservar, $FinAReservar)
    {
       ...
       // ->orwhereBetween($InicioAReservar,array('Tbl_Citas.Inicio as inicio','Tbl_Citas.Fin as fin') )
       // ->orwhereBetween($FinAReservar,array('Tbl_Citas.Inicio as inicio','Tbl_Citas.Fin as fin') )
